...
import { addNotesToProject, getNotes, type Note, type Project } from '../../api/client';
...
export function useAddNotesPanel({ loadProjects, refreshExpandedDetail }: UseAddNotesPanelOptions) {
  // 添加笔记面板（同时只打开一个）
